...
const messages = {
  en: {
    ...
    "auth.code.delayed.phone": "Your code is taking longer than usual to send. If it arrives, it will work. If it doesn't, ask for a new one when the timer below runs out.",
    "auth.code.delayed.email": "Your code is taking longer than usual to send. If it arrives, it will work. If it doesn't, ask for a new one when the timer below runs out.",
  ...
  te: {
    ...
    "auth.code.delayed.phone": "మీ కోడ్ పంపడానికి మామూలు కంటే ఎక్కువ సమయం పడుతోంది. అది వస్తే పని చేస్తుంది. రాకపోతే, కింది టైమర్ ముగిశాక కొత్త కోడ్ అడగండి.",
    "auth.code.delayed.email": "మీ కోడ్ పంపడానికి మామూలు కంటే ఎక్కువ సమయం పడుతోంది. అది వస్తే పని చేస్తుంది. రాకపోతే, కింది టైమర్ ముగిశాక కొత్త కోడ్ అడగండి.",
  ...
  hi: {
    ...
    "auth.code.delayed.phone": "आपका कोड भेजने में सामान्य से ज़्यादा समय लग रहा है। अगर यह आ जाए, तो काम करेगा। न आए, तो नीचे का टाइमर खत्म होने पर नया कोड माँगें।",
    "auth.code.delayed.email": "आपका कोड भेजने में सामान्य से ज़्यादा समय लग रहा है। अगर यह आ जाए, तो काम करेगा। न आए, तो नीचे का टाइमर खत्म होने पर नया कोड माँगें।",
