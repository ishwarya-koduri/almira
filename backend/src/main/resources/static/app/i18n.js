...
const messages = {
  en: {
    ...
    "where.keyHolderPlaceholder": "Amma",
    "where.keyHolderHelp": "Just a name, as you'd say it. It isn't linked to anyone and we never contact them.",
    ...
    "where.legacy": "An unsealed note on this record also says where it's kept: “{text}”. Anyone who can see the record can read it, and so can our server.",
    "where.legacyMove": "Seal it, and clear the unsealed note",
    "where.legacyMoved": "Sealed. The unsealed note is cleared.",
    "where.legacyKept": "The sealed line above isn't one you can open, so the unsealed note stays until it can be moved safely.",
    "where.captureNote": "{label}: record this sealed, under “Where the original is” on the saved record. It isn't asked for here, because this form is not sealed.",
    ...
    "ready.reason.location_unsealed": "Where it is is in an unsealed note. Seal it.",
  ...
  te: {
    ...
    "where.keyHolderPlaceholder": "అమ్మ",
    "where.keyHolderHelp": "మీరు పిలిచే పేరు చాలు. ఇది ఎవరికీ లింక్ కాదు, మేము వారిని సంప్రదించం.",
    ...
    "where.legacy": "ఈ రికార్డులో మూయని ఒక గమనిక కూడా ఎక్కడ ఉందో చెబుతోంది: “{text}”. రికార్డు చూడగలిగే ఎవరైనా, మా సర్వర్ కూడా, దాన్ని చదవగలరు.",
    "where.legacyMove": "దాన్ని మూసివేసి, మూయని గమనికను తీసేయండి",
    "where.legacyMoved": "మూసివేశాం. మూయని గమనిక తీసేశాం.",
    "where.legacyKept": "పైన మూసివేసిన వివరం మీరు తెరవగలిగేది కాదు, అందుకే సురక్షితంగా మార్చగలిగే వరకు మూయని గమనిక అలాగే ఉంటుంది.",
    "where.captureNote": "{label}: దీన్ని సేవ్ చేసిన రికార్డులో “అసలు పత్రం ఎక్కడ ఉంది” కింద మూసివేసి నమోదు చేయండి. ఈ ఫారం మూసివేయబడదు, అందుకే ఇక్కడ అడగడం లేదు.",
    ...
    "ready.reason.location_unsealed": "ఇది ఎక్కడ ఉందో సీల్ చేయని నోట్‌లో ఉంది. దాన్ని సీల్ చేయండి.",
  ...
  hi: {
    ...
    "where.keyHolderPlaceholder": "अम्मा",
    "where.keyHolderHelp": "बस एक नाम, जैसे आप बोलते हैं। यह किसी से जुड़ा नहीं है और हम उनसे कभी संपर्क नहीं करते।",
    ...
    "where.legacy": "इस रिकॉर्ड पर एक बिना सील का नोट भी बताता है कि यह कहाँ रखा है: “{text}”। जो भी यह रिकॉर्ड देख सकता है वह इसे पढ़ सकता है, और हमारा सर्वर भी।",
    "where.legacyMove": "इसे सील करें, और बिना सील का नोट हटाएँ",
    "where.legacyMoved": "सील हो गया। बिना सील का नोट हटा दिया गया।",
    "where.legacyKept": "ऊपर की सील की हुई पंक्ति आप नहीं खोल सकते, इसलिए बिना सील का नोट तब तक रहेगा जब तक उसे सुरक्षित रूप से हटाया न जा सके।",
    "where.captureNote": "{label}: इसे सहेजे गए रिकॉर्ड पर “असली कागज़ कहाँ है” में सील करके दर्ज करें। यह फ़ॉर्म सील नहीं होता, इसलिए यहाँ नहीं पूछा जाता।",
    ...
    "ready.reason.location_unsealed": "यह कहाँ है, वह एक बिना सील के नोट में लिखा है। उसे सील करें।",
